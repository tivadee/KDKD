...
class ControllerReportCustomerOrder extends Controller {
		...
		$this->document->setTitle($this->language->get('กราฟแสดงลูกค้าที่ซื้อสินค้าสูงสุด'));
		...
		$results = $this->model_report_customer->getOrders2($filter_data);
		...
		$data['grp'] = $this->language->get('grp');
...
$data['grpp'] = $this->url->link('report/customer_order2/grp', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('report/customer_order2.tpl', $data));
	}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
...
$data['grpp'] = $this->url->link('report/customer_order/grp', 'token=' . $this->session->data['token'], 'SSL');
