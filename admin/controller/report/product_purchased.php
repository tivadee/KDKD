...
class ControllerReportProductPurchased extends Controller {
	...
	public function grp() {
		...
		$this->document->setTitle($this->language->get('กราฟแสดงยอดขายทั้งหมดของสินค้า'));
		...
		$this->response->setOutput($this->load->view('report/product_purchased2.tpl', $data));
	}
...
///////////////////////////////////////		
$data['grpp'] = $this->url->link('report/product_purchased/grp', 'token=' . $this->session->data['token'], 'SSL');		
//////////////////////////////////		
