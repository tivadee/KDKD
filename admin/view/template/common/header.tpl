...
<header id="header" class="navbar navbar-static-top">
  <div class="navbar-header">
    ...
    <?php }else{ ?>
    <a type="button" id="button-menu" class="pull-left" style="display:none"> </i></a>
    <?php } ?>
    <a href="<?php echo $home; ?>" class="navbar-brand"><img src="view/image/logo.png" height="28" width="200" alt="<?php echo $heading_title; ?>" title="<?php echo $heading_title; ?>" /></a></div>
  <?php if ($logged) { ?>
